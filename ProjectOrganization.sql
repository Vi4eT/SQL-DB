...
CREATE TABLE Employee(
	...
	[Type] varchar(16) NOT NULL 
		CONSTRAINT CK_Employee_Type CHECK ([Type] IN (' онструктор', '»нженер', '“ехник', 'Ћаборант', '—ервис')),
	[DeptID] int NOT NULL
)
GO
...
CREATE TABLE [Contract](
	...
	[HeadID] int NOT NULL REFERENCES Employee (ID)
		CONSTRAINT CK_Contract_HeadID_Type CHECK (dbo.get_type(HeadID) IN (' онструктор', '»нженер')),
...
CREATE TABLE Project(
	...
	[Name] varchar(50) NOT NULL,
	[HeadID] int NOT NULL REFERENCES Employee (ID)
		CONSTRAINT CK_Project_HeadID_Type CHECK (dbo.get_type(HeadID) IN (' онструктор', '»нженер')),
	[StartDate] date NOT NULL,
	[EndDate] date NOT NULL,
	[Cost] money NOT NULL,
...
GO
--категори€ сотрудников в договоре
DECLARE @a date = '20200101'
DECLARE @b date = '20201231'
